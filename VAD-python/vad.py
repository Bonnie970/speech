...
class VoiceActivityDetector():
    ...
    def __init__(self, wave_input_filename):
        ...
        self.speech_window = 0.01 #half a second
        self.speech_energy_threshold = 0.6 #60% of energy in voice band
        self.speech_start_band = 100 # voice frequency is 300-3000
        self.speech_end_band = 8000 # !!! we don't care about human perception, let CNN finds more details
